...
public class ShelfGuiStandAloneApp {
	...
	private CommandPostFactoryWithParameters newShelfCommand;
	private CommandGetFactoryWithParameters findAShelf;
	private CommandGetFactoryWithoutParameters findAllShelfs;

	/**
	 * Constructor
	 */
	public ShelfGuiStandAloneApp() {
		newShelfCommand =  new NewShelf.Factory();
		findAShelf = new FindShelf.Factory();
		findAllShelfs = new FindAllShelfs.Factory();
	}
	 ...
	 * @throws IOException
	 */
	public void createContentPane(JFrame frame, ShelfGuiStandAloneApp demo)
			throws IOException {
	...
	private static void createAndShowGUI() throws IOException {
		...
		ShelfGuiStandAloneApp demo = new ShelfGuiStandAloneApp();
	...
	private class EventThread implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			if (ev.getActionCommand().equals("UserList")) {
				...
				new ShelfRepositorySwing(newShelfCommand, findAllShelfs, findAShelf);
			}
