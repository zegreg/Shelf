...
/**
 * 
 * Class whose instance gives a User Interface Representation of the domain Class {@code CreateShelf()} 
...
         created an instance of the inner class EventShelfSearch() and EventShelfDelete()*/
    ...
    /**
     * Inner class that contains the code that is executed when it is pressed the jbDelete button.
     * 
     */
