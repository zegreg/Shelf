...
public class DVDCollection extends JFrame {
	...
	private JTextField textField;
	 ...
	 private void createContentPanel(UserRepository repository,
        ...
        criada uma instância da classe EventoDVDCollection,
        onde está o código que deve ser executado quando tal acontece*/

    	 btnAdddvdCollection.addActionListener(new EventDVDCollection(repository,shelfRepository,elementsRepository));
	}
	 ...
	 private class EventDVDCollection implements ActionListener{
    	 ...
    	 public EventDVDCollection(UserRepository repository, ShelfRepository shelfRepository, ElementsRepository elementsRepository) {
    		 this.userRepository = repository;
    		 this.shelfRepository = shelfRepository;
    		 this.elementsRepository = elementsRepository;
    	 }
    	 ...
    	 public void actionPerformed(ActionEvent e) {
    		 ...
    		 SwingWorker worker = new SwingWorker() {
    			 ...
    			 protected  String doInBackground() throws Exception {
    				 ...
    				 map.put("elementType", "DVDCollection");
    				 ...
    				 //			main.java.FHJ.shelf.model.DVDCollection dvdCollection = 
    				 // 			new main.java.FHJ.shelf.model.DVDCollection(jtfShelfData.getText(), textField.getText(), textField.getText(), textField.getText());



    				 //					DVDCollection.this.shelfRepository.insert(dvdCollection);
