...
/**
 * Class that implements the command to obtain the {@link Shelf} instance with a
 * given identifier.
 */
public class GetShelf extends BaseGetCommand implements Command {

	/**
	 * Class that implements the {@link GetShelf} factory, according to the
	...
	/**
	 * Initiates an instance with the given shelf repository and command
	 * parameters
	 * 
	 * @param repository
	...
	protected Map<String, String> putCommandResultInAMapPreparedForTheOutput(
		...
		containerOfCommandResult.put("Capacity",
				String.valueOf(shelf.getCapacity()));
		containerOfCommandResult.put("FreeSpace",
				String.valueOf(shelf.getFreeSpace()));
