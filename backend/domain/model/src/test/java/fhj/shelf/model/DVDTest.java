...
public class DVDTest
{
	...
	public void constructDVD() {
		dvd1 = new DVD(1,"A dvd", 120 );
		dvd2 = new DVD(2, "A dvd", 100 );
		dvd3 = new DVD( 3,"Big DVD", 1000 );
		dvd4 = new Book(4, "A dvd", "Sony" );
		dvd5 = new DVD(5, "A dvd", 120 );
	}
	...
	public void shouldBeTheSameDVD() {
		assertEquals( 0, dvd1.compareTo( new DVD(8, "A dvd", 120 ) ) );
		assertEquals( 0, dvd1.compareTo( dvd1 ) );
	}
	
	@Test
	public void shouldNotBeTheSameDVD() {
		assertTrue( 0 != dvd1.compareTo( new DVD(9, "Other dvd", 10 ) ) );
	...
	public void shouldBeEqual() {
		assertTrue( dvd1.equals( new DVD( 10,"A dvd", 120 ) ) );
		assertTrue( dvd1.equals( dvd5 ) );
	}
	
	@Test
	public void shouldNotBeEqual() {
		assertFalse( dvd1.equals( new DVD( 11,"Other dvd", 100 ) ) );
